...
export default function SharingBox({ id }: { id: string }) {
  return (
    <div className="relative">
      <input
        ...
        value={`https://alzheimers-society.tedspace.dev/redirect/${id}`}
        disabled
        readOnly
      />
      <button
        onClick={() => {
          copy(`https://alzheimers-society.tedspace.dev/redirect/${id}`);
